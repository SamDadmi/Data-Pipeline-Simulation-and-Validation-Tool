...
export const PipelineUI = ({ updateMessage }) => {
  ...
  const onDrop = useCallback(
    (event) => {
      ...
      if (event?.dataTransfer?.getData('application/reactflow')) {
        ...
        addNode(newNode);
        // Show message after adding a node
        updateMessage(`Node of type ${type} added.`);
      }
    },
    [reactFlowInstance, getNodeID, addNode, updateMessage]
  );
